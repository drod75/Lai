...
<div>
  ...
  <ul class="m-8 list flex flex-col gap-4">
    ...
    <li class="flex items-stretch bg-sky-100 rounded-box border-l-8 border-sky-600">
      <div class="p-4 bg-white rounded-r-box w-full shadow-md">
        <div class="mb-2">
          <div class="text-2xl font-bold text-sky-600">Agent</div>
          <div class="uppercase font-semibold opacity-60 text-xs">The Agent Source Code...</div>
        </div>
    ...
    <li class="flex items-stretch bg-fuchsia-100 rounded-box border-l-8 border-fuchsia-400">
      <div class="p-4 bg-white rounded-r-box w-full shadow-md">
        <div class="mb-2">
          <div class="text-2xl font-bold text-fuchsia-900">UI</div>
          <div class="uppercase font-semibold opacity-60 text-xs">The UI Source Code...</div>
        </div>
        <p class="text-sm leading-relaxed">
    ...
    <li class="flex items-stretch bg-violet-100 rounded-box border-l-8 border-violet-400">
      <div class="p-4 bg-white rounded-r-box w-full shadow-md">
        <div class="mb-2">
          <div class="text-2xl font-bold text-violet-900">Utils</div>
          <div class="uppercase font-semibold opacity-60 text-xs">The Utils Source Code...</div>
        </div>
        <p class="text-sm leading-relaxed">
